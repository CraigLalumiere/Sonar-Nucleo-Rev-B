...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA0     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = XDCR_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(XDCR_RX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = WaterTemp_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(WaterTemp_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA0     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(XDCR_RX_GPIO_Port, XDCR_RX_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(WaterTemp_GPIO_Port, WaterTemp_Pin);
