...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOC, GAIN_SEL_0_Pin | GAIN_SEL_1_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pin : GAIN_SEL_2_Pin */
    GPIO_InitStruct.Pin  = GAIN_SEL_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GAIN_SEL_2_GPIO_Port, &GPIO_InitStruct);

    /*Configure GPIO pins : FW_LED_Pin CS_Pin nHV_DISCHARGE_Pin */
    GPIO_InitStruct.Pin   = FW_LED_Pin | CS_Pin | nHV_DISCHARGE_Pin;
    GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull  = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
